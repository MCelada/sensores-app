...
class TemperatureSensorsScreen extends StatefulWidget {
  static const String name = 'temperature-sensors';
...
class _TemperatureSensorsScreenState extends State<TemperatureSensorsScreen> {
  ...
  @override
    void initState() {
    super.initState();
    // Usar Provider para acceder a la base de datos
    final db = Provider.of<AppDatabase>(context, listen: false);
    _sensorsFuture = db.sensorDao.findByTipo('temperatura');
  }

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Sensores de Temperatura')),
      body: FutureBuilder<List<Sensor>>(
        ...
        builder: (context, snapshot) {
          ...
          if (sensors.isEmpty) {
            return const Center(child: Text('No hay sensores de temperatura.'));
          }
                ...
                child: ListTile(
                  ...
                  subtitle: Column(
                    ...
                    children: [
                      ...
                      GestureDetector(
                        onTap: () {
                          // Abre el datasheet en el navegador
