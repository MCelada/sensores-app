...
class LightSensorsScreen extends StatefulWidget {
  static const String name = 'light-sensors';

  const LightSensorsScreen({super.key});

  @override
  State<LightSensorsScreen> createState() => _LightSensorsScreenState();
}

class _LightSensorsScreenState extends State<LightSensorsScreen> {
  ...
  void initState() {
    ...
    _sensorsFuture = db.sensorDao.findByTipo('luz');
  }

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Sensores de Luz')),
      body: FutureBuilder<List<Sensor>>(
        ...
        builder: (context, snapshot) {
          ...
          if (sensors.isEmpty) {
            return const Center(child: Text('No hay sensores de luz.'));
          }
