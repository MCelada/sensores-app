...
class DistanceSensorsScreen extends StatefulWidget {
  static const String name = 'distance-sensors';

  const DistanceSensorsScreen({super.key});

  @override
  State<DistanceSensorsScreen> createState() => _DistanceSensorsScreenState();
}

class _DistanceSensorsScreenState extends State<DistanceSensorsScreen> {
  ...
  void initState() {
    ...
    _sensorsFuture = db.sensorDao.findByTipo('distancia');
  }

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Sensores de Distancia')),
      body: FutureBuilder<List<Sensor>>(
        ...
        builder: (context, snapshot) {
          ...
          if (sensors.isEmpty) {
            return const Center(child: Text('No hay sensores de distancia.'));
          }
